...
class FaultToleranceConfig:
    ...
    * `segment_health_check_dir` [str|None] Shared directory containing the current
      segment health decision artifact. Allocation-unit process 0 checks the artifact
    ...
    # Segment health check: shared directory containing the current decision artifact
