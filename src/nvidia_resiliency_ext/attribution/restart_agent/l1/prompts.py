...
- Original log text is source evidence. decision_evidence is the canonical deterministic
  ...
  conflict.
- selected_evidence_references are trace references. Do not assume their object IDs can
  be resolved unless get_evidence_objects is advertised as a tool. An unresolved object
  ID or source-line reference does not expose evidence and cannot support a claim.
