...
- root-cause status, calibration-eligible model confidence, semantic primary
  class/line, and identity-kind agreement;
- grounded root-fingerprint agreement for causal identities, or selected
  observation and observation-fingerprint agreement for observation-only
  identities; these remain separate measurements;
