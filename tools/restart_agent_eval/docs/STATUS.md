...
- Incremental shared-L0, deterministic, and per-route artifact visibility.
...
- Independent deterministic, route-primary, and route-observation projection,
  like-kind L3 history, and explicit L4 path-selection reporting.
...
5. Measure terminal request-to-result at target scale; add progressive replay
   only for profiles that explicitly enable pre-end polling.
