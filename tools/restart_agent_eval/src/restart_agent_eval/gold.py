...
OBJECT_FIELDS = MappingProxyType(
    {
        ...
        "observation_expectation": frozenset(
            {
                "require_primary_absent",
                "accepted_lines",
                "line_tolerance",
                "accepted_failure_classes",
                "accepted_causal_roles",
                "accepted_observation_fingerprints",
            }
        ),
...
UNSUPPORTED_CLAIM_FIELDS = frozenset({"id", "text_patterns"})
