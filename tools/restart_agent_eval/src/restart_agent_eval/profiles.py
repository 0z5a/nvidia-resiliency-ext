...
# Qwen235B remains available as an explicit target but is not in the default panel.
MODEL_TARGETS = ("qwen397b", "nemotron", "gpt", "claude", "gemini")
...
MODEL_PROFILES: Mapping[str, ModelProfile] = MappingProxyType(
    {
        ...
        "gpt": ModelProfile("us/azure/openai/eccn-gpt-5.6-sol", SECONDARY_KEY_ENV),
        "claude": ModelProfile(
            "us/azure/anthropic/eccn-claude-opus-5",
            SECONDARY_KEY_ENV,
        ),
        "gemini": ModelProfile(
